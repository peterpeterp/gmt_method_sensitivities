...
for scenario in ['rcp85']:
	for var in var_names:
		group=variable[var]
		os.system('cdo -O -selyear,1861/2099 '+var+'_'+scenario+'.nc '+var+'_'+scenario+'_1861-2099.nc')
		os.system('cdo -O -selyear,1861/2014 '+var+'_'+scenario+'.nc '+var+'_'+scenario+'_1861-2014.nc')

	if os.path.isfile('tos_rcp85_noTosCheck.nc'):
		os.system('cdo -O -selyear,1861/2099 '+'tos_rcp85_tosError.nc '+'tos_rcp85_tosError_1861-2099.nc')
		os.system('cdo -O -selyear,1861/2014 '+'tos_rcp85_tosError.nc '+'tos_rcp85_tosError_1861-2014.nc')
